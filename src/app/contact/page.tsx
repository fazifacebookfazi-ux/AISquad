    ...
    <>
      ...
      <Container className="pb-24 lg:pb-32">
        <div className="grid gap-14 lg:grid-cols-[1.35fr_0.85fr] lg:gap-20">
          <Reveal>
            <div className="border-2 border-mist-100/15 bg-ink-900 p-8 sm:p-10">
              <ContactForm />
            </div>
          </Reveal>
          ...
          <div className="flex flex-col gap-10 lg:sticky lg:top-28 lg:self-start">
            <Reveal delay={0.1}>
              <div className="flex flex-col gap-3">
                ...
                <a
                  ...
                  className="group inline-flex items-center gap-2 font-display text-xl font-bold tracking-tight text-mist-100"
                >
                  {site.email}
            ...
            <Reveal delay={0.16}>
              <div className="flex flex-col gap-6 border-2 border-mist-100/12 bg-ink-900 p-7">
                  ...
                  {steps.map((step, i) => (
                    <li key={step.title} className="flex gap-4">
                      <span className="relative flex flex-col items-center">
                        <span className="grid size-10 shrink-0 place-items-center border-2 border-brand-400/70 bg-brand-400/10 font-mono text-xs font-black text-brand-400">
                          {String(i + 1).padStart(2, "0")}
                        </span>
                        {i < steps.length - 1 ? (
                          <span
                            aria-hidden
                            className="mt-2 w-0.5 flex-1 bg-mist-100/15"
                          />
                        ) : null}
                      </span>
            ...
            <Reveal delay={0.22}>
              <div className="flex flex-col gap-3 border-2 border-brand-400/60 bg-brand-400/6 p-6">
